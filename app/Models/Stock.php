...
{
    protected $fillable = ['id', 'all_product_id', 'initial_price', 'quantity', 'price', 'language', 'state', 'idArticleMKM', 'stock', 'isFoil','signed','playset','altered', 'on_sale', 'comments', 'update'];
